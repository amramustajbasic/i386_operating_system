...
// Mapiramo Virtualnu adresu [Kernbase, Kernbase + 4MB) na fizicku 
// adresu [0MB, 4MB]
// Takodjer mapiramo Virtualnu adresu [0, 4MB) u tu istu fizicku adresu
//
//
//PD i PT moraju startati na granici stranice, tj moraju biti poravnate
//i djeljive sa 4096 odnosno 4KB, za to se koristi __aligned__ atribut
//
//Zbog staticke inicijalizacije u c-u koristimo nesto + PTE_P 
//umjesto | jer to ovdje u ovom slucaju nije podrzano
//PGSIZE = 4069 b
...
pde_t entry_pgdir[NPDENTRIES] = {
  ...
  //Shiftamo 0xF0000000 za 22
  //dobijemo 10 najtezih bita
  //kako bi dobili indeks koji korespondira kernbase u PD
	[KERNBASE>>PDXSHIFT]
		= ((uintptr_t)entry_pgtable - KERNBASE) + PTE_P + PTE_W
      //sada ova dva regiona pokazuju na isti dio fizicke mem
};
